...
{  
	...
	public void chaxun(){
		...
		map.put("MERC_ID", "301101010017987");
		map.put("ORD_AMT", "0.01");
		map.put("TX_DESC", "1");
		map.put("BIP_ORD_NO", "1888441");
	...
	public void rfd(){
		...
		map.put("SUB_BUS_TYP", "1");
		map.put("BIP_CD", "1");
		map.put("BIP_ORD_DT", "20160912");
		map.put("MERC_ID", "301101010017987");
		map.put("ORD_AMT", "0.01");
		map.put("TX_DESC", "1");
		map.put("BIP_ORD_NO", "201605300002509924");
		map.put("RUT_CORG", "ALIPAY");
		String ma="7010012";
		get(map,ma);
    }
	...
	public void c(){
		...
		map.put("BUS_CNL", "QRP");
		map.put("SYS_CNL", "QRP");
		map.put("BUS_TYP", "020B");
		map.put("SUB_BUS_TYP", "1");
		map.put("BIP_CD", "1");
		map.put("BIP_ORD_DT", "20160912");
		map.put("MERC_ID", "301101010017987");
		map.put("BIP_ORD_NO", "201605300002509963");
		String ma="7010016";
		get(map,ma);
    }
